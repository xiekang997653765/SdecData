...
public class AppSmartTrashBin {
    public static void main (String[] args) {
        ...
        trashBinSub.setStartDate("2018-05-16"); //数据密集点
         ...
         * 细节请看 TestHandler
         * */
        DataHandler handler = new HandlerSmartTrashBin();
         ...
         * */
        new StreamDataSubscribe(handler, trashBinSub).start();
...
//
//        /****** 选填条件开始 ********/
//        parameter.setDeviceId("866971030608439");  //根据设备ID查找
